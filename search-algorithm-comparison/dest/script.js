...
function onClick() {
    ...
    const { foundIndex: binaryIndex, timeTaken: binaryTime } = findTime(binarySearch, sortedRandomArray, 5);
    const { foundIndex: linearIndex, timeTaken: linearTime } = findTime(linearSearch, randomArray, 5);
...
function displayArray(array) {
    ...
    arrayDisplay.textContent = `[...${array[array.length - 5]}, ${array[array.length - 4]}, ${array[array.length - 3]}, ${array[array.length - 2]}]`;
